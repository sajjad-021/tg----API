...
key,text = do_keyboard_spam(bk),'🖱تنظیمات شما با موفقیت تغییر کرد :\n'
end
...
key,text = do_keyboard_warn(bk),'تغییرات اخطار ها :\n'
save_data(data, 'data/' .. bk .. '/' .. bk .. '.lua')
end
...
key,text = do_keyboard_spam(bk),'🖱شما وارد تنظیمات انتی اسپم گروه خود شدید :\n'
