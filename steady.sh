...
echo -e "\e[100m                                 Writed by sajjad_021                                 \e[00;37;40m"
echo -e "\e[01;34m                                  For tgGuard source                                  \e[00;37;40m"
echo ""

sleep 1

# Checking if the bot folder is in HOME
echo -e "$bld$f4 CHECKING INSTALLED tgGuard-BOT...$rst"
sleep 1
